...
public class OneTimeInverseConsultationV2 {
	...
	public ArrayList<TranslatablePair> obtainTranslationScoresFromLexicalEntry(
		...
		translatablePairs = obtainTranslationScoresFromLexicalEntry(
				sourceLemma, sourceLexicalEntry, 
				translationSetURI1, translationSetURI2);
	 ...
	 */	
	public  ArrayList<TranslatablePair> obtainTranslationScoresFromLexicalEntry(
			String sourceLemma, String sourceLexicalEntry, 
			String translationSetURI1, String translationSetURI2){
